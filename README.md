...
The packages in the `visp` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy visp` on `Mon, 08 Jun 2026 10:06:08 -0000`
...
The packages in the `visp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted visp` on `Fri, 05 Jun 2026 13:03:05 -0000`
...
The packages in the `visp` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble visp` on `Fri, 05 Jun 2026 12:52:01 -0000`
...
## visp (rolling) - 3.7.0-7

The packages in the `visp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling visp` on `Thu, 04 Jun 2026 16:33:00 -0000`
...
## visp (lyrical) - 3.7.0-8

The packages in the `visp` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical visp` on `Thu, 04 Jun 2026 16:26:25 -0000`
...
## visp (rolling) - 3.7.0-6

The packages in the `visp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling visp` on `Thu, 04 Jun 2026 15:34:31 -0000`
...
## visp (lyrical) - 3.7.0-7

The packages in the `visp` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical visp` on `Thu, 04 Jun 2026 15:25:37 -0000`
...
## visp (rolling) - 3.7.0-4

The packages in the `visp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling visp` on `Thu, 05 Mar 2026 08:24:24 -0000`
...
The packages in the `visp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted visp` on `Thu, 05 Mar 2026 08:17:39 -0000`
...
The packages in the `visp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted visp` on `Wed, 04 Mar 2026 15:46:31 -0000`
...
The packages in the `visp` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble visp` on `Wed, 04 Mar 2026 15:39:45 -0000`
...
## visp (rolling) - 3.7.0-2

The packages in the `visp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling visp` on `Wed, 04 Mar 2026 07:52:37 -0000`
...
The packages in the `visp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted visp` on `Wed, 04 Mar 2026 07:42:15 -0000`
...
The packages in the `visp` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble visp` on `Wed, 04 Mar 2026 07:36:04 -0000`
...
## visp (rolling) - 3.7.0-1

The packages in the `visp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling visp` on `Tue, 03 Mar 2026 15:44:15 -0000`
...
The packages in the `visp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted visp` on `Tue, 03 Mar 2026 15:30:10 -0000`
...
The packages in the `visp` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble visp` on `Tue, 03 Mar 2026 14:30:54 -0000`
...
The packages in the `visp` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble visp` on `Mon, 02 Mar 2026 16:22:46 -0000`
...
The packages in the `visp` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble visp` on `Mon, 02 Mar 2026 15:12:42 -0000`
...
The packages in the `visp` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release visp --rosdistro indigo --track indigo` on `Wed, 16 Apr 2014 08:27:05 -0000`
